package com.example.tianqiyubao1;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void search(){
        ...
        //构造Request对象
        //采⽤建造者模式，链式调⽤指明进⾏Get请求,传⼊Get的请求地址
        Log.d("api","https://restapi.amap.com/v3/geocode/geo?address="+address.getText().toString()+"&output=XML&key=7f4c7b2696eced7d5f25a562a641674a");
